...
for (var i = 0;i < data.length; i++){
  ...
  if (data[i][1] < 100 && data[i][1] > 0){
    changeColor(data[i][0],"#ffb499")

  }
  else if (data[i][1] > 100 && data[i][1] < 500){
    changeColor(data[i][0],"#ff6a32")
    console.log("hierboven 100-500")
  }
  else if (data[i][1] > 500 && data[i][1] < 2000){
    changeColor(data[i][0],"#e53e00")
    console.log("hierboven")
  }
  else if (data[i][1] > 2000 && data[i][1] < 10000){
    changeColor(data[i][0],"#cc3700")
    console.log("hierboven")
  }
  else if (data[i][1] > 10000){
    changeColor(data[i][0],"#661b00")
...
function changeColor(id, color) {
  for (z = 0; z< country_codes.length; z++){

    console.log("country check")
    for (l = 0; l < 3; l++){
      if (country_codes[z][l] == id){
        console.log('gevonden')
        for (var k = 0; k < 3; k++){
          console.log(z,k)
          arrayPath = document.getElementsByClassName(country_codes[z][k]);
          if (arrayPath != []){
            console.log(arrayPath);
            for (var p = 0; p < arrayPath.length; p++) {
              arrayPath[p].style.fill = color;
