...
// TODO: add code here
	for ( var i = 0; i < 7; i++){
 		elementList = document.querySelectorAll("li")[i];
 		ApplePie.ingredients.push(elementList.innerHTML);
	}
console.log(ApplePie.ingredients);

creatorhtml = document.getElementById('header');
smaller = creatorhtml.getElementsByTagName('p');
ApplePie.creator = smaller[0].innerHTML;
...
link = document.getElementsByTagName('img')[0]
console.log(link)
link.addEventListener("click", yolo);
